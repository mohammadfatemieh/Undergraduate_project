...
FRESULT f_open (
	...
	BYTE mode			/* Access mode and file open mode flags 访问模式和文件打开方式的标志*/
)
{
	FRESULT res;
	DIR dj;
...
FRESULT f_write (
	...
	UINT btw,			/* Number of bytes to write写入的字节数 */
	UINT *bw			/* Pointer to number of bytes written 指针写入的字节数*/
)
{
	FRESULT res;
	DWORD clst, sect;
...
/*-----------------------------------------------------------------------*/
/* Current Drive/Directory Handlings            当前驱动目录                         */
/*-----------------------------------------------------------------------*/
...
#if _FS_MINIMIZE <= 2
/*-----------------------------------------------------------------------*/
/* Seek File R/W Pointer        寻找文件读写指针                                         */
/*-----------------------------------------------------------------------*/
...
#if _FS_MINIMIZE <= 1
/*-----------------------------------------------------------------------*/
/* Create a Directroy Object       创建一个Drectroy 对象                                      */
/*-----------------------------------------------------------------------*/

FRESULT f_opendir (
	DIR *dj,			/* Pointer to directory object to create指针指向的目录对象来创建 */
	const TCHAR *path	/* Pointer to the directory path 指针指向的目录路径*/
)
{
	FRESULT res;
	DEF_NAMEBUF;
